  ...
  return (
    <div className="py-12 flex flex-col items-center gap-6 px-4">
      ...
      >
        ...
        >
          <img src={uniLogo} alt="University of Wolverhampton" className="h-24 object-contain" style={{ mixBlendMode: "screen" }} />
        </div>
        ...
        >
          ...
          {/* Title */}
          <h1 className="text-[40px] font-bold leading-[1.1] text-white mb-1 tracking-wide">
